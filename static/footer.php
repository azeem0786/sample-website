        ...
        <div class="tdb-md-row font-tdb15">
            <div class="tdb-md-3 left bold-tdb3 padding-bottom-tdb10">
                <div class="padding-right-tdb15">
                    ...
                    <a href="home-collection.php" class="padding-right-tdb5 l-tdb30">Home Collection</a><br />
...
<div class="popup position-f-tdb top-tdb0 left-tdb0 w-per-tdb100 h-per-tdb100" style="z-index:1000;background-color:rgba(0,0,0,0.4);overflow:auto;display:none">
    ...
    <div class="tdb-md-row">
        ...
        <div class="b-tdb-white padding-tdb10">
                ...
                <div>
                    ...
                    <div class="padding-tdb30 b-tdb-white">


                        <br />
                        <b class="bold-tdb7 c-tdb-red8 font-tdb25">REQUEST A CALL</b>
                        <p class="c-tdb-gray7"> Please provide following details</p>
                        <br />
                        <div>
                            <div>
                            ...
                            <button class="sub_button btn-tdb b-tdb-red8 bold-tdb3 s-center1-tdb c-tdb-gray1 margin-tdb0 letter-tdb5 w-per-tdb100" style="padding:18px 15px 18px 15px;">Request Now</button><br /><br />
...
<script>
    ...
    $(document).ready(function() {
        $(".sub_button").click(function() {
            var booking = $('.sub_button').val().trim();
            ...
            var address = $('.address').val().trim(); {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data == '3') {
                            swal("Required", "Please Enter Your Name", "warning");
                        } else if (data == '4') {
                            swal("Required", "Please Enter Your Contact Number", "warning");
                        } else if (data == 1) {
                            var first = $('#first').val('');
                            var phone = $('#phone').val('');
                            var email = $('#email').val('');
